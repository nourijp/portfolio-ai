      ...
      <div className="container">
        <div className="pt-16 md:pt-32 pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <form action="https://formspree.io/f/mlgkplad" method="POST">
              <div className="flex flex-col gap-7 sm:gap-12">
                ...
                <input type="hidden" name="source_site" value="ai.hamednouri.com" />
                <input type="hidden" name="email_to" value="work@nouri.cc" />
              </div>
            </form>
